        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-lg font-semibold text-dark-gray6 leading-none">Vision</div>
                <div className="text-xs text-dark-gray4 -mt-0.5">Security Dashboard</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-dark-gray2 border border-dark-gray3 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="py-2">
                  <button className="w-full px-4 py-2 text-left text-dark-gray4 hover:bg-dark-gray1 hover:text-dark-gray6 transition-colors">
                    Profile
                  </button>
                  <button className="w-full px-4 py-2 text-left text-dark-gray4 hover:bg-dark-gray1 hover:text-dark-gray6 transition-colors">
                    Settings
